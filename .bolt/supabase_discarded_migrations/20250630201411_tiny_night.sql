/*
  # Add nursing prompts to database
  
  1. New Content
    - Adds 52 new nursing prompts to the prompts table
    - Covers various nursing scenarios, questions, and educational content
    - Each prompt has appropriate categories and tags
  
  2. Data Structure
    - All prompts use the existing schema
    - Anonymous prompts with is_anonymous set to TRUE
    - Content and prompt_text fields are populated with the same text
*/
