...
export const mockUserProfiles = [
  { id: 'user1', username: 'sarah_icu_rn', full_name: 'Sarah Johnson', specialty: 'ICU' },
  { id: 'user2', username: 'mike_medsurg', full_name: 'Michael Chen', specialty: 'Medical-Surgical' },
  { id: 'user3', username: 'emily_er_nurse', full_name: 'Emily Rodriguez', specialty: 'Emergency Room' },
  { id: 'user4', username: 'david_charge', full_name: 'David Thompson', specialty: 'ICU' },
  { id: 'user5', username: 'lisa_peds_rn', full_name: 'Lisa Park', specialty: 'Pediatrics' },
  { id: 'user6', username: 'james_rapid', full_name: 'James Wilson', specialty: 'Medical-Surgical' },
  { id: 'user7', username: 'amanda_mh', full_name: 'Amanda Davis', specialty: 'Mental Health' },
  { id: 'user8', username: 'rob_critical', full_name: 'Robert Martinez', specialty: 'ICU' },
];